 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "tcd.ie", ownerName = "tcd.ie", packagePath="scss.dsg.particpatory"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyCkdZtUn3Y3kcR2Qnv51qI1f9ysWB7faP8";
