...
import ie.tcd.scss.dsg.particpatory.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "tcd.ie", ownerName = "tcd.ie", packagePath = "scss.dsg.particpatory"))
